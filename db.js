// This file would normally be where you put your database connection
...
// Defining our data. This could come from a database
const products = [
    {
...
const data = {categories, products, reviews};
